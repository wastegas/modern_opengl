...
int main()
{
  ...
  Shader lightingShader("./material_ex1.vs",
			"./material_ex1.fs", nullptr);
  Shader lightCubeShader("./lightCube_ex1.vs",
			 "./lightCube_ex1.fs", nullptr);
  ...
  while(!glfwWindowShouldClose(window))
    {
      ...
      lightingShader.setVec3("material.diffuse", 0.50980392f, 0.50980392f,
			     0.50980392f);
      lightingShader.setVec3("material.specular", 0.50196078f, 0.50196078f,
			     0.50196078f);
